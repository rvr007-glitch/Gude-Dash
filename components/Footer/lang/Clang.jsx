                 ...
                 If the person had learned driving on a manual car,
                  he could have easily driven the automatic car as well.
                   ...
                   to learn any modern programming language as well. As learning C help to understand
                    ...
                    memory locations etc. It will Be the Most Used Languamnge in College. So Can't Ignore C..
                    C is the next best thing to assembly if you want to know about low level programming.
C is the main language for all Unix and Linux systems.
Embedded software are mostly written in C, specially for resource constrained devices.
Short of assembly, no other language comes closer to hardware
If you want every bit of speed you can squeeze, you program in C
If you want control over resources you program in C
C is used for OS kernels and device drivers
Nobody owns it
It's just another great skill to have
Above all, if you know C, you know “how things work”
For a developer of resource-constrained applications either C or C++ or both is definitely mandatory, because these languages allow you to make the most of memory, CPU and other resources (at the expense of being somewhat more difficult to learn and use).  `} /></div>
